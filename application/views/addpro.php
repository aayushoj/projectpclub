...
<div   class="positive ui button" style="margin-left:800px;margin-top:0px;" onclick="submitupload()">UPLOAD</div>
<br>
<div   class="positive ui button" style="margin-left:80px;margin-top:0px;" onclick="submitupload()">SAVE</div>
</form>
